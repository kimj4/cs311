 ...
 * the code was tested fairly thoroughly and there are no known errors.
 * due to running out of time however, tests specifically for vertices that may make floor/ceil matter has not been done
 */
